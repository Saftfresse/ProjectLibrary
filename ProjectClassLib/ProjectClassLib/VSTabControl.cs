...
namespace ProjectClassLib
{
    public partial class VSTabControl : TabControl
    {
        ...
        [Description("BackgroundColor"), Category("Appearance"), DisplayName("BackgroundColor")]
        public Color BackgroundColor { get => backgroundColor; set => backgroundColor = value; }
        [Description("SelectedTabColor"), Category("Appearance"), DisplayName("SelectedTabColor")]
        public Color SelectedTabColor { get => selectedTabColor; set => selectedTabColor = value; }
        [Description("UnselectedTabColor"), Category("Appearance"), DisplayName("UnselectedTabColor")]
        public Color UnselectedTabColor { get => unselectedTabColor; set => unselectedTabColor = value; }
        [Description("UnselectedTabColor"), Category("Appearance"), DisplayName("UnselectedTabColor")]
        public bool AllowClose { get => allowClose; set => allowClose = value; }
        public Color HoverTabColor1 { get => HoverTabColor; set => HoverTabColor = value; }
        public Color HoverTabButtonColor1 { get => HoverTabButtonColor; set => HoverTabButtonColor = value; }
        public Color HoverUnselectedTabButtonColor1 { get => HoverUnselectedTabButtonColor; set => HoverUnselectedTabButtonColor = value; }
        public Color BorderTabLineColor1 { get => BorderTabLineColor; set => BorderTabLineColor = value; }
        public Color UnderBorderTabLineColor1 { get => UnderBorderTabLineColor; set => UnderBorderTabLineColor = value; }
        public Color TextColor1 { get => TextColor; set => TextColor = value; }
        public Color UnselectedBorderTabLineColor1 { get => UnselectedBorderTabLineColor; set => UnselectedBorderTabLineColor = value; }
        public Color SelectedTabButtonColor1 { get => SelectedTabButtonColor; set => SelectedTabButtonColor = value; }
        public Color UpDownBackColor1 { get => UpDownBackColor; set => UpDownBackColor = value; }
        public Color UpDownTextColor1 { get => UpDownTextColor; set => UpDownTextColor = value; }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.DrawLine(new Pen(new SolidBrush(this.FindForm() == Form.ActiveForm ? this.BorderTabLineColor1 : this.UnselectedBorderTabLineColor1), 2), new Point(0, 22), new Point(base.Width, 22));
            g.FillRectangle(new SolidBrush(this.UnderBorderTabLineColor1), 0, 23, base.Width, 1);
            ...
            for (var i = 0; i < this.TabCount; i++)
            {
                ...
                if (this.FindForm() != Form.ActiveForm && base.SelectedIndex == i) // unselected selected tab
                    ...
                    g.FillRectangle(new SolidBrush(this.HoverTabColor1), tabSize);
                else // unselected tab
                ...
                if (base.SelectedIndex == i)
                {
                    if (allowClose)
                    {
                        ...
                        if (new Rectangle((tabBase.Location.X + tabBase.Width) - (15 + 3), tabBase.Location.Y + 3, 15, 15).Contains(this.PointToClient(Cursor.Position)))
                            g.FillRectangle(new SolidBrush(this.FindForm() == Form.ActiveForm ? this.SelectedTabButtonColor1 : this.HoverUnselectedTabButtonColor1),
                                new RectangleF((tabBase.Location.X + tabBase.Width) - (15 + 3), tabBase.Location.Y + 3, 15, 15));

                        g.TextContrast = 0;
                        g.DrawString("×", new Font(this.Font.FontFamily, 15f), new SolidBrush(this.TextColor1),
                ...
                else
                {
                    ...
                    if (hoveringTabIndex == i)
                    {
                        if (allowClose)
                        {
                            ...
                            if (new Rectangle((tabBase.Location.X + tabBase.Width) - (15 + 3), tabBase.Location.Y + 3, 15, 15).Contains(this.PointToClient(Cursor.Position)))
                                g.FillRectangle(new SolidBrush(this.HoverTabButtonColor1),
                                    new RectangleF((tabBase.Location.X + tabBase.Width) - (15 + 3), tabBase.Location.Y + 3, 15, 15));
                ...
                g.TextContrast = 12;
                g.DrawString(base.TabPages[i].Text, new Font(this.Font.FontFamily, this.Font.Size), new SolidBrush(this.TextColor1),
        ...
        internal void DrawIcons(Graphics g)
        {
            ...
            Brush br = new SolidBrush(UpDownBackColor1);
            g.FillRectangle(br, r0);
            br.Dispose();

            g.DrawString("◀", new Font(this.Font.FontFamily, 12f),
                new SolidBrush(UpDownTextColor1), r0);

            g.DrawString("▶", new Font(this.Font.FontFamily, 12f),
                new SolidBrush(UpDownTextColor1),
